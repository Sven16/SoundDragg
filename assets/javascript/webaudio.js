...
handleFiles('http://10.104.103.124:8080/assets/images/me.jpg');
...
function visualize() {
  ...
  // console.log(visualSetting);
    ...
    canvasVisual.clearRect(0, 0, WIDTH, HEIGHT);
    ...
    function draw() {
      ...
      canvasVisual.fillStyle = 'rgb(200, 200, 200)';
      canvasVisual.fillRect(0, 0, WIDTH, HEIGHT);

      canvasVisual.lineWidth = 2;
      canvasVisual.strokeStyle = 'rgb(0, 0, 0)';

      canvasVisual.beginPath();
      ...
      for(var i = 0; i < bufferLength; i++) {
        ...
        if(i === 0) {
          canvasVisual.moveTo(x, y);
        } else {
          canvasVisual.lineTo(x, y);
        }

        x += sliceWidth;
      }

      canvasVisual.lineTo(canvas2.width, canvas2.height/2);
      canvasVisual.stroke();
    };
